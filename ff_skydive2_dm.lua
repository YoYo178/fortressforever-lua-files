...
function player_spawn( player_entity )
	...
	player:AddAmmo(Ammo.kShells, 16)
...
healthkit = weapon:new({ health = 25, model = "models/items/healthkit.mdl", materializesound = "Item.Materialize", respawntime = 20, touchsound = "HealthKit.Touch" })
