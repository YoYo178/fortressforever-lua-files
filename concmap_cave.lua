...
red_cap1        = basecap:new({
	team = Team.kRed,
	item = { "blue_flag" }
})
red_cap2        = basecap:new({
	team = Team.kRed,
	item = { "green_flag" }
})
red_cap3        = basecap:new({
	team = Team.kRed,
	item = { "yellow_flag" }
})

-- blue cap points					
blue_cap        = basecap:new({
	team = Team.kBlue,
	item = { "red_flag" }
})
blue_cap1       = basecap:new({
	team = Team.kBlue,
	item = { "blue_flag" }
})
blue_cap2       = basecap:new({
	team = Team.kBlue,
	item = { "green_flag" }
})
blue_cap3       = basecap:new({
	team = Team.kBlue,
	item = { "yellow_flag" }
})

-- yellow cap points					
yellow_cap      = basecap:new({
	team = Team.kYellow,
	item = { "red_flag" }
})
yellow_cap1     = basecap:new({
	team = Team.kYellow,
	item = { "blue_flag" }
})
yellow_cap2     = basecap:new({
	team = Team.kYellow,
	item = { "green_flag" }
})
yellow_cap3     = basecap:new({
	team = Team.kYellow,
	item = { "yellow_flag" }
})

-- green cap points					
green_cap       = basecap:new({
	team = Team.kGreen,
	item = { "red_flag" }
})
green_cap1      = basecap:new({
	team = Team.kGreen,
	item = { "blue_flag" }
})
green_cap2      = basecap:new({
	team = Team.kGreen,
	item = { "green_flag" }
})
green_cap3      = basecap:new({
	team = Team.kGreen,
	item = { "yellow_flag" }
})
------------------------------------------------------------------
