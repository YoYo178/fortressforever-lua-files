...
location_stage30 = location_info:new({ text = "The End", team = NO_TEAM })
...
trigger_message1 = trigger_message_base:new({ message="Almost ending D:" })
trigger_message2 = trigger_message_base:new({ message="Congratulations... You have completed conc_speed :D!!!" })
trigger_message3 = trigger_message_base:new({ message="Bow down to the glory of seven" })
trigger_message4 = trigger_message_base:new({ message="Thks for playng :D" })
trigger_message7 = trigger_message_base:new({ message="type !start and stop to get your time at zE Palace Servers " })
