...
function startup()
	...
	--Turn on the light entities on startup
	OutputEvent( "fr_button_light_left_red", "TurnOn" )
	OutputEvent( "fr_button_light_right_red", "TurnOn" )
	OutputEvent( "fr_button_light_left_blue", "TurnOn" )
	OutputEvent( "fr_button_light_right_blue", "TurnOn" )	
end
