-----------------------------------------------------------------------------
-- conc_nine_alpha by pew pew ze beams
-----------------------------------------------------------------------------
...
location_stage6 = location_info:new({ text = "Stage z", team = NO_TEAM })
location_stage7 = location_info:new({ text = "Stage 6", team = NO_TEAM })
location_stage8 = location_info:new({ text = "Stage 7", team = NO_TEAM })
location_stage9 = location_info:new({ text = "Stage 8", team = NO_TEAM })
location_stage10 = location_info:new({ text = "Stage 9", team = NO_TEAM })
location_stage11 = location_info:new({ text = "Stage 10", team = NO_TEAM })
location_stage0 = location_info:new({ text = "The End", team = NO_TEAM })
