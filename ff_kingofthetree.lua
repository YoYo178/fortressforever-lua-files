...
function startup()
    ...
    SetTeamName( Team.kBlue, "Blue Tree Huggers" )
    SetTeamName( Team.kRed, "Red Wood Choppers" )
    SetTeamName( Team.kGreen, "Green Peace Squad" )
    SetTeamName( Team.kYellow, "Yellow Wood Peckers" )
