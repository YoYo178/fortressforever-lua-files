...
location_blue_batts	= location_info:new({ text = "Upper Battlements", team = Team.kBlue })

location_blue_fdoor	= location_info:new({ text = "Lower Front Door", team = Team.kBlue })

location_blue_ramproom		= location_info:new({ text = "Ramp Room", team = Team.kBlue })

location_spawn_blue	= location_info:new({ text = "Blue Spawn", team = Team.kBlue })

location_blue_middle	= location_info:new({ text = "Middle Connector", team = Team.kBlue })

location_blue_sideramp	= location_info:new({ text = "Side Ramp", team = Team.kBlue })

location_blue_shorthall	= location_info:new({ text = "Short Hall", team = Team.kBlue })
...
location_spawn_red	= location_info:new({ text = "Red Spawn", team = Team.kRed })

location_red_middle	= location_info:new({ text = "Middle Connector", team = Team.kRed })

location_red_sideramp	= location_info:new({ text = "Side Ramp", team = Team.kRed })

location_red_shorthall	= location_info:new({ text = "Short Hall", team = Team.kRed })
