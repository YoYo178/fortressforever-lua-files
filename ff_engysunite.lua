...
location_bluearmory = location_info:new({ text = "Blue Armory", team = Team.kBlue })
...
location_redarmory = location_info:new({ text = "Red Armory", team = Team.kRed })
...
location_yellowarmory = location_info:new({ text = "Yellow Armory", team = Team.kYellow })
...
location_greenarmory = location_info:new({ text = "Green Armory", team = Team.kGreen })
