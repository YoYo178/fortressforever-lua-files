...
function customflagcap:allowed( allowed_entity )
	...
	if IsPlayer( allowed_entity ) then
		...
		if player:GetTeamId() == self.team then
			if  player:HasItem(self.rmpflag) then
...
rofspawn = { validspawn = red_o_only }
rdespawn = { validspawn = red_d_only }
...
blofspawn = { validspawn = blue_o_only }
bldespawn = { validspawn = blue_d_only }
