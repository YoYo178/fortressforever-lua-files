...
IncludeScript("base_tournament");

-- tournament settings
TOURNAMENT_PLAYERS_PER_TEAM = 2
TOURNAMENT_PLAYERS_PER_TEAM_MAX = 2
TOURNAMENT_RANDOM_SEEDS = true
