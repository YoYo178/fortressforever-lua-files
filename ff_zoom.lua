...
function startup()
	...
	SetTeamName(Team.kBlue, " Speed Demons")
	SetTeamName(Team.kRed,  " LeadFoot Hellions")
...
function strip_conc:ontouch(touch_entity)
	...
	if class == Player.kScout then BroadCastMessageToPlayer( player, "Concs stripped" )   end	             
         end
end
...
jump_1 	= base_trigger_jumppad:new({push_horizontal = 1024, push_vertical = 512, })
jump_2 	= base_trigger_jumppad:new({push_horizontal = 1024, push_vertical = 50, })
jump_3 	= base_trigger_jumppad:new({push_horizontal = 1500, push_vertical = 0, })
jump_3a = base_trigger_jumppad:new({push_horizontal = 1024, push_vertical = 100, })
jump_4 	= base_trigger_jumppad:new({push_horizontal = 1024, push_vertical = 50, })
