...
red_grate_trigger  = base_grate_trigger:new({
	team      = Team.kRed,
	team_name = "red",
	message   = "Red grate has been destroyed!"
})
blue_grate_trigger = base_grate_trigger:new({
	team      = Team.kBlue,
	team_name = "blue",
	message   = "Blue grate has been destroyed!"
})
