...
-- custom death sound
-------------------------------------------------------------------------
local death_sound = "customsound.pilk"
...
death_sounds = { 
	[Player.kScout] = "customsound.pilk",
	[Player.kSniper] = "customsound.knob",
	[Player.kSoldier] = "customsound.laff",
	[Player.kDemoman] = "customsound.knob",
	[Player.kMedic] = "customsound.pilk",
	[Player.kHwguy] = "customsound.laff",
	[Player.kPyro] = "customsound.laff",
	[Player.kSpy] = "customsound.knob",
	[Player.kEngineer] = "customsound.laff",
	[Player.kCivilian] = "customsound.pilk"
}
-------------------------
-- flaginfo
-------------------------
