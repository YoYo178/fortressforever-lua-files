...
-- bag flagrooms
-----------------------------------------------------------------------------------------------------------------------------
ff_2fat_flagbag = genericbackpack:new({
	health = 30,
	armor = 40,
...
function ff_2fat_flagbag:dropatspawn() return false end
blue_2fat_flagbag = ff_2fat_flagbag:new({ touchflags = { AllowFlags.kOnlyPlayers, AllowFlags.kBlue } })
red_2fat_flagbag = ff_2fat_flagbag:new({ touchflags = { AllowFlags.kOnlyPlayers, AllowFlags.kRed } })