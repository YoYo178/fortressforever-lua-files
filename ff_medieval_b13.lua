...
--DEFENCE SPAWN GRENADES
blue_bag_grenades = genericbackpack:new({ 
	health = 0,
	armor = 0,
	grenades = 0,
	shells = 0,
...
red_bag_grenades = genericbackpack:new({ 
	health = 0,
	armor = 0,
	grenades = 0,
	shells = 0,
...
spawn_red_engy = function(self,player)
	return ((player:GetTeamId() == Team.kRed)
	and (player:GetClass() == Player.kEngineer))
end
...
spawn_blue_engy = function(self,player)
	return ((player:GetTeamId() == Team.kBlue)
	and (player:GetClass() == Player.kEngineer))
end
